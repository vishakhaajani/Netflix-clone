        ...
        <div className='hero-bg relative'>
            ...
            <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleSubmit}>
                    <input type="email" id='email' className='p-2 rounded flex-1 bg-black/80 border border-gray-700' placeholder='Email Address' value={email} onChange={(e) => setEmail(e.target.value)} />
                    <button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center item-center'>
                        Get Started
                    </button>
                </form>
            </div>
